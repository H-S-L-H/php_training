...
Route::get('ajax/students', 'Ajax\StudentAjaxController@index')->name('ajaxstudents');
Route::get('ajax/studentEdit/{id}', 'Ajax\StudentAjaxController@edit')->name('ajaxstudents.edit');